...
export const NounprojectPanel = observer(({ store, query }: PanelProps) => {
  // load data
...
export const FlatIconPanel = observer(({ store, query }: PanelProps) => {
  // load data
...
export const IconFinderPanel = observer(({ store, query }: PanelProps) => {
  // load data
  const count = 50;
...
export const IconsPanel = ({ store }: PanelProps) => {
  const requestTimeout = React.useRef<NodeJS.Timeout | undefined>(undefined);

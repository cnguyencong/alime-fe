  ...
  return (
    <MessagePrimitive.Root asChild>
      <div
        ...
        data-role="assistant"
      >
        <div className="aui-assistant-message-content mx-2 flex leading-7 break-words text-foreground">
          <div className="relative mr-2 h-6 min-h-6 w-6 min-w-6">
            <img src="/images/construix_bot.svg" alt="Construix Bot" />
          </div>
...
const AssistantActionBar: FC = () => {
  return (
    ...
    >
      {/* Simple feedback buttons to match the design */}
